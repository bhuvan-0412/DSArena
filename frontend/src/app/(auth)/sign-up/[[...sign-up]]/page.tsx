      ...
      >
        <div className="text-center space-y-3">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 text-xs font-mono uppercase tracking-widest font-extrabold">
            <Sparkles className="w-3.5 h-3.5" /> Start Your Legend
          </div>
          <h1 className="text-3xl font-black text-white tracking-tight">
            Create your <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-indigo-400">DSArena</span> Account
          </h1>
          <p className="text-xs text-slate-400 leading-relaxed max-w-sm mx-auto">
            Sign up with Google to conquer the Striver A2Z Roadmap, build your streak, and save your progress in the cloud.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2 text-[11px] font-mono text-slate-300">
          <div className="p-2.5 rounded-xl bg-slate-950/60 border border-slate-800/80 flex items-center gap-2">
            ...
            <span>Automatic Progress Sync</span>
          </div>
          <div className="p-2.5 rounded-xl bg-slate-950/60 border border-slate-800/80 flex items-center gap-2">
